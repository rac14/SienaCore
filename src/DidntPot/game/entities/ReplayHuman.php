...
class ReplayHuman extends Human
{
     ...
     */
    public function getBlockBroken(): ?Vector3
    {
    ...
    public function startFishing(): void
    {
        if (!$this->isFishing()) {
            ...
            $tag = Entity::createBaseNBT($pos->add(0.0, $this->getEyeHeight(), 0.0), $this->getDirectionVector(), $this->yaw, $this->pitch);
     ...
     * @return int
     */
    #[Pure] public function getItemUseDuration(): int
    {
    ...
    {
        return !($this->paused) && parent::doOnFireTick($tickDiff);
    }
